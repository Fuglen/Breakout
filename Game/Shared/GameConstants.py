...
class GameConstants:
    ...
    SOUND_FILE_HIT_BRICK = os.path.join("Assets", "BrickHit_1.wav")
    SOUND_FILE_HIT_BRICK_LIFE = os.path.join("Assets", "ExtraLife_2.wav")
    SOUND_FILE_HIT_BRICK_SPEED = os.path.join( "Assets", "SpeedUp_2.wav")
    SOUND_FILE_HIT_WALL = os.path.join("Assets", "WallBounce_1.wav")
    SOUND_FILE_HIT_PAD = os.path.join("Assets", "PadBounce_1.wav")
